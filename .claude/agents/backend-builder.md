...
they need to be applied + types regenerated. Server functions that need real secrets / DB can't
be exercised offline — say so. Once vitest is installed per `docs/06 §1`, also run
